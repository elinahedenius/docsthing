(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["Libp2PMplex"] = factory();
	else
		root["Libp2PMplex"] = factory();
})(window, function() {
...
const FIFO = __webpack_require__(12);
...
const AbortError = __webpack_require__(18); // Wrap an iterator to make it abortable, allow cleanup when aborted via onAbort
...
const pipe = __webpack_require__(11);

const pushable = __webpack_require__(1);

const log = __webpack_require__(2)('libp2p:mplex');

const abortable = __webpack_require__(3);

const Coder = __webpack_require__(19);

const restrictSize = __webpack_require__(6);
...
const createStream = __webpack_require__(29);
...
const FixedFIFO = __webpack_require__(13);
...
exports.encode = __webpack_require__(20);
...
const BufferList = __webpack_require__(0);
...
const BufferList = __webpack_require__(0); // Decode a chunk and yield an _array_ of decoded messages
...
const AbortController = __webpack_require__(30);

const log = __webpack_require__(2)('libp2p:mplex:stream');
