...
const errCode = __webpack_require__(1);
...
const multicodec = __webpack_require__(33);

const codecs = __webpack_require__(3);

const CIDUtil = __webpack_require__(38);

const withIs = __webpack_require__(39);
/**
...
const protons = __webpack_require__(42);

const pb = protons(__webpack_require__(53));
...
const extractDataFromBlock = __webpack_require__(6);

const validateOffsetAndLength = __webpack_require__(7);

const UnixFS = __webpack_require__(13);
...
const resolve = __webpack_require__(40);

const last = __webpack_require__(76);
...
const base16 = __webpack_require__(30);

const base32 = __webpack_require__(31);

const base64 = __webpack_require__(32); // name, code, implementation, alphabet
...
const intTable = __webpack_require__(34);

const codecNameToCodeVarint = __webpack_require__(35);
...
exports.print = __webpack_require__(37);
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(0).Buffer))
...
const baseTable = __webpack_require__(3); // map for hexString -> codecName
...
const varintEncode = __webpack_require__(12).varintEncode; // map for codecName -> codeVarintBuffer
...
const table = __webpack_require__(3); // map for codecConstant -> code
...
const table = __webpack_require__(3); // map for code -> print friendly name
...
const resolvers = {
  'dag-pb': __webpack_require__(41),
  raw: __webpack_require__(73),
  'dag-cbor': __webpack_require__(74),
...
const findShardCid = __webpack_require__(54);
...
const contentExporters = {
  raw: __webpack_require__(16),
  file: __webpack_require__(16),
  directory: __webpack_require__(71),
  'hamt-sharded-directory': __webpack_require__(72),
...
var encodings = __webpack_require__(48);

var compileDecode = __webpack_require__(50);

var compileEncode = __webpack_require__(51);

var compileEncodingLength = __webpack_require__(52);
...
var svarint = __webpack_require__(49);
...
var defined = __webpack_require__(5).defined;
...
const Bucket = __webpack_require__(55);

const multihashing = __webpack_require__(14); // FIXME: this is copy/pasted from ipfs-unixfs-importer/src/dir-sharded.js
...
const SparseArray = __webpack_require__(56);

const wrapHash = __webpack_require__(57);
...
const ConsumableBuffer = __webpack_require__(58);
...
const sha3 = __webpack_require__(60);

const mur = __webpack_require__(63);

const sha = __webpack_require__(65);

const {
  fromNumberTo32BitBuf
} = __webpack_require__(66); // Note that although this function doesn't do any asynchronous work, we mark
...
module.exports = {
  ...
  addBlake: __webpack_require__(67)
};
...
(function () {
  ...
  var AMD =  true && __webpack_require__(62);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(61), __webpack_require__(8)))
...
const blake = __webpack_require__(68);
...
var b2b = __webpack_require__(69);

var b2s = __webpack_require__(70);
...
var util = __webpack_require__(15); // 64-bit unsigned addition
...
// Adapted from the reference implementation in RFC7693
// Ported to Javascript by DC - https://github.com/dcposch
var util = __webpack_require__(15); // Little-endian byte access.
...
const mh = __webpack_require__(14).multihash;
